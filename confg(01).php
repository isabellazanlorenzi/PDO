...
$stmt = $pdo>prepare('INSERT INTO '.$TABELA.' ('cliente_id', 'nome', 'email', 'telefone', 'endereco', 'estado_id', 'cidade_id', 'observações')
VALUES (:cliente_id, :nome, :email, :telefone, :endereco, :estado_id, :cidade_id, :observações)');

 $stmt>bindParam(':nome', 'Isa Zanlorenzi');
 $stmt>bindParam(':email', 'bellazanlorenzi@gmail.com');
 $stmt>bindParam(':telefone', 'XXXX-XXXXX');
 $stmt>bindParam(':endereco', 'sem endereço');
 $stmt>bindParam(':estado_id', '00');
 $stmt>bindParam(':cidade_id', '0000');
 $stmt>bindParam(':observações', 'observações');
